...
class Horse(Base):
    ...
    breedings_as_dam = relationship(
        "Breeding", back_populates="dam", foreign_keys="Breeding.dam_id"
    )
    breedings_as_sire = relationship(
        "Breeding", back_populates="sire", foreign_keys="Breeding.sire_id"
    )
...
class Breeding(Base):
    ...
    # Beziehungen
    dam = relationship(
        "Horse", back_populates="breedings_as_dam", foreign_keys=[dam_id]
    )
    sire = relationship(
        "Horse", back_populates="breedings_as_sire", foreign_keys=[sire_id]
    )
