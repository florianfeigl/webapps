...
def add_id_to_front_matter(directory, start_id=0):
    file_paths = [os.path.join(directory, f) for f in sorted(os.listdir(directory)) if f.endswith('.md')]
...
# Usage
add_id_to_front_matter('/home/florian/Projects/Websites/182bit.org/posts/')
